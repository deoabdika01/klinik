            ...
            <div class="card-body">
              <div class="media d-flex">
                ...
                <?php
                    ...
                    ?>
                  <span>Jumlah pasien saat ini</span><br>
            ...
            <div class="card-body">
              <div class="media d-flex">
                ...
                <?php
                  ...
                  <a href="./page/pasien.php" class="btn btn-success btn-sm active" role="button" aria-pressed="true">LIHAT</a>
                </div>
                <div class="align-self-center">
                  <i class="icon-user success font-large-2 float-right"></i>
                </div>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="media d-flex">
                ...
                <div class="align-self-center">
                  <i class="icon-arrow success font-large-2 float-right"></i>
                </div>
              </div>
            </div>
          </div>
